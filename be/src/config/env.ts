...
const envSchema = z.object({
  ...
  ORCHESTRATOR_ENABLED: booleanFromString(false),
  ORCHESTRATOR_INTERVAL_MS: integerFromString(300_000),
  DRIFT_THRESHOLD_BPS: integerFromString(300),
...
export const envBootSummary = {
  ...
  orchestratorIntervalMs: env.ORCHESTRATOR_INTERVAL_MS,
